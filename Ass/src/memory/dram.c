...
uint64_t read64bits_dram(uint64_t paddr){
    ...
    value += (((uint64_t)mm[paddr + 0])) << 0; // convert to uint64_t
    value += (((uint64_t)mm[paddr + 1])) << 8;
    value += (((uint64_t)mm[paddr + 2])) << 16;
    value += (((uint64_t)mm[paddr + 3])) << 24;
    value += (((uint64_t)mm[paddr + 4])) << 32;
    value += (((uint64_t)mm[paddr + 5])) << 40;
    value += (((uint64_t)mm[paddr + 6])) << 48;
    value += (((uint64_t)mm[paddr + 7])) << 56;
